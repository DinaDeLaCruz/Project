...
urlpatterns = [
    ...
    url('', include(('apps.mascota.urls','mascota'), namespace='mascota')),
    ...
    url(r'^reset/password_reset', PasswordResetView.as_view(template_name='registration/password_reset_form.html',
        ...
        name='password_reset'),
    url(r'^password_reset_done', PasswordResetDoneView.as_view(template_name='registration/password_reset_done.html'),
        name='password_reset_done'),
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$',
        PasswordResetConfirmView.as_view(template_name='registration/password_reset_confirm.html'),
        name='password_reset_confirm'
        ),
    url(r'^reset/done', PasswordResetConfirmView.as_view( template_name= 'registration/password_reset_complete.html'),
